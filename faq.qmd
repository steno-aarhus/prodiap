...
.callout-title {
    ...
    color: #FFFFFF !important; /* Ren hvid tekst */
    font-weight: bold; /* Gør teksten kraftigere */
    text-shadow: 0px 0px 2px rgba(255, 255, 255, 0.8); /* Lidt skygge for ekstra skarphed */
    padding: 10px;
    border-radius: 5px;
}
