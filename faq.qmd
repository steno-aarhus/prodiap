...
.callout .callout-header {
    background-color: rgb(153, 0, 51) !important; /* Sætter baggrundsfarve */
    color: #FFFFFF !important; /* Sætter tekstfarve til hvid */
    font-weight: bold !important; /* Gør teksten fed */
    text-shadow: 0px 0px 2px rgba(255, 255, 255, 0.8) !important; /* Skaber skyggeeffekt */
